    ...
    <div ref={ref} className="bg-white p-10 max-w-[800px] mx-auto text-sm text-gray-800" style={{ width: '800px', minHeight: '1100px' }}>
      ...
      <div className="flex justify-between items-start mb-12">
        <div>
          ...
          <div className="mt-4">
             <img src={fullLogo} alt="MARYONÉ.shop" className="h-12 object-contain" />
          </div>
        </div>
        <div className="text-right text-gray-600 text-xs">
          <p className="font-bold text-gray-900 mb-1">From</p>
          <p className="font-bold text-lg">MARYONÉ.shop</p>
          <p>Hzaibag, Gazipur sadar</p>
          <p>Gazipur</p>
          <p>1700</p>
          <p>8801715346424</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-8 mb-12">
        ...
        <div className="text-right">
             ...
             <p className="mb-1"><span className="font-bold">Order date:</span> {data.date}</p>
          ...
          <tbody className="divide-y divide-gray-50">
             {data.items.map((item, index) => (
                <tr key={item.id}>
                    ...
                    <td className="py-4">
                        <img src={item.image} alt="" className="w-8 h-8 object-cover rounded bg-gray-100" />
                    </td>
