...
const navigation = [
  ...
  { name: 'Wishlist', href: '/wishlist' }, // External link to existing wishlist page
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-12">
          {/* Sidebar */}
          <aside className="lg:col-span-3 py-6 px-2 sm:px-0">
            <nav className="space-y-1">
              {navigation.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group flex items-center px-6 py-4 text-sm font-bold rounded-l-md transition-colors ${
                      isActive
                        ? 'bg-gray-100 text-gray-900 border-l-4 border-transparent' // Image shows gray bg, no explicit left border but standard active style
