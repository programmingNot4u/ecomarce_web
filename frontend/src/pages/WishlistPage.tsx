...
const WishlistPage = () => {
    ...
    if (!user) {
        return (
            <div className="text-center py-20 bg-gray-50 rounded-lg">
                <p className="text-gray-500 text-lg mb-6">Please log in to view your wishlist.</p>
                <Link
                    to="/login"
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 mb-6">My Wishlist</h2>
            {/* Wrapper removed, now part of dashboard content */}
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                    {wishlist.map((item) => {
                        ...
                        if (!product) return null; // Skip malformed items
                            ...
                            <div key={item.id} className="group relative flex flex-col">
                                ...
                                <div className="mt-4 flex justify-between flex-1">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">{product.category_name || product.category}</p>
                                    </div>
                                ...
                                <button
                                    ...
                                    className="absolute top-2 right-2 p-2 bg-white rounded-full text-gray-400 hover:text-red-500 transition-colors shadow-sm z-20"
